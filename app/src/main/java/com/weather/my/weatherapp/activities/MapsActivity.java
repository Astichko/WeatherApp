...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String LOG = "MapAcitivity";
...
//                        tileType, zoom, x, y);
                URL url = null;
                try {
                    url = new URL(OWM_TILE_URL);
                    Log.v(LOG, "createTileProvider url created");
                } catch (MalformedURLException mfe) {
                    Log.v(LOG, "createTileProvider wrong url");
                    mfe.printStackTrace();
                }
